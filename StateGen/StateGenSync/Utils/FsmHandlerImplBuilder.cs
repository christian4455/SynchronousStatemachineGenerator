...
namespace StateGen.StateGenSync.Utils
{
    public class FsmHandlerImplBuilder : IFsmHandlerImplBuilder
    {
        ...
        private string CreateClass(string filename)
        {
            ...
            result.AppendLine("    m_CurrentActivity(::Activity::ActivityInitial),");
            ...
            result.AppendLine("    RunStateMachine(this, ::Activity::ActivityInitial);");
            result.AppendLine("}");
            result.AppendLine("");
            result.AppendLine("//******************************************************");
            ...
            result.AppendLine("            if ((event == fsm->m_pTransitionTable[i].m_Event) || (::Events::Any == fsm->m_pTransitionTable[i].m_Event))");
            result.AppendLine("            {");
            ...
            result.AppendLine("                    fsm->m_CurrentActivity = fsm->m_pTransitionTable[i].m_NextActivity;");
            result.AppendLine("");
