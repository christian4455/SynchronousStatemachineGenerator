...
namespace StateGen
{
    public class main
    {
        ...
        const string menuHeader = "-&Statemachine Generator";
        const string generateSyncStatemachine = "&Generate synchronous statemachine";
        ...
        public void SetupStatemachineGeneratorSync()
        {
            ...
            // register the plugin
            // Todo [cb] buttons map abhängig von der registermap machen!!
